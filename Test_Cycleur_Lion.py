...
try :
    os.remove("/home/pi/Documents/Test_Cycleur_Lion/data_cycleur_Lion.txt")
    print("File Removed!")
...
while True :
    ...
    #    print(ser_bytes)
        ...
        with open("/home/pi/Documents/Test_Cycleur_Lion/data_cycleur_Lion.txt","a+") as Data:
            Data.write(Pretty_Line + "\n" )
            
        if os.stat("/home/pi/Documents/Test_Cycleur_Lion/data_cycleur_Lion.txt").st_size > Max_File_Size :
             break
