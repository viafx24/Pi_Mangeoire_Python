...
def main():
    ...
    while Number_Of_Videos < 5000:
        ...
        Global_Iteration = Global_Iteration + 2 #DANGER avec le 2
        ...
        Lead_Zero_Iteration=str(Iteration_Of_Video + 1).zfill(5)
        video_name= "//home/pi/mnt/USB_Cam_Mangeoire/Video/video_" + Lead_Zero_Iteration + ".mp4"
        print(video_name)
        Lead_Zero_Iteration=str(Iteration_Of_Video + 2).zfill(5)
