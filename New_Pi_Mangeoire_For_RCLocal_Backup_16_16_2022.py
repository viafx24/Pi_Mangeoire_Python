...
def main():
    ...
    Voltage_Limit_To_Shutdown_Raspi = 14.6
    ...
    while Number_Of_Videos < 5000:
        ...
        if Raspi_Voltage < (Voltage_Limit_To_Shutdown_Raspi) :            
            ...
            with open("//home/pi/mnt/USB_Cam_Mangeoire/Log.txt","a")  as Data:
                 Data.write("Entering the close condition due to Time limit  at " + str(datetime.datetime.now().strftime("%d/%m/%Y %H:%M:%S"))  + "\n" )
        ...
        Lead_Zero_Iteration=str(Number_Of_Videos+1).zfill(5)
        ...
        if ser.in_waiting: #to avoid to do the ser.write during light sleep.
            ...
            if ser.in_waiting:
                ...
                if Line == "Epoch received\r\n":
                    ...
                    print("problem:Epoch not received")
                    with open("//home/pi/mnt/USB_Cam_Mangeoire/Log.txt","a")  as Data:
                        Data.write("problem:Epoch not received" + "\n" )
                    i=0
...
#         
#             with open("//home/pi/mnt/USB_Cam_Mangeoire/Log.txt","a")  as Data:
#                 Data.write(Two_Epoch + "\n" )
#             #time.sleep(15) #critical
#             
#             
#             
#         
...
#             Line=ser.readline().decode()
#             
#             while Line is not "Epoch received\r\n":
#             
#                 print("problem:Epoch not received")
#                 print(Line)
#                 
